      ...
      <main className={styles.page}>
        ...
        <section className={styles.content}>
          ...
          <div className={styles.descriptionKo}>
            <p>
            꿈은 두 가지 의미가 있습니다. 밤에 잠들 때 나타나는 현상으로서의 꿈, 그리고 인생에 있어서 이루고자 하는 목표로서의 꿈.<br></br>
심리학자 지그문트 프로이트의 ‘꿈의 해석'을 읽고, 두 종류의 꿈은 그리 다르지 않다는 것을 발견했습니다. 밤에 꾸는 꿈은 목표로서의 꿈, 즉 내재된 욕망을 재료로 삼아 만들어지기 때문입니다.<br></br>
하지만 꿈은 너무나도 빠르게 사라져버리고 맙니다. 내가 도달하고 싶었던 이상향을 잊고 살다가, 밤이 되어서야 보여주고 눈을 뜨고 나면 기억이 나지 않습니다. 마치 아침 이슬처럼요. 두 종류의 꿈들이 모두 증발하기 전에 기록해보는 건 어떨까요? 어떤 욕망이 나도 모르게 슬며시 튀어나왔는지 확인해보세요. 꿈을 타인에게 권할 수도 있고, 다른 사람의 꿈을 살 수도 있어요.
            ...
            <p>
            'Dream' has two meanings: dreams as phenomena that appear when we fall asleep at night, and dreams as goals we wish to achieve in life.<br></br>
            After reading Sigmund Freud’s The Interpretation of Dreams, I discovered that these two kinds of dreams are not so different. Dreams we have at night are created by using the material of our aspirations, our goals and latent desires.<br></br>
